      ...
      <Container fluid className="text-center py-4 bg-dark">
        ...
        <Container className='my-2'>
            <Link to="https://www.instagram.com/andrea.barocchi/">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="gray" className="bi bi-instagram mx-2" viewBox="0 0 16 16">
            ...
            <Link to="https://github.com/AndreaBar94">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="gray" className="bi bi-github mx-2" viewBox="0 0 16 16">
            ...
            <Link to="https://www.linkedin.com/in/andrea-barocchi/">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="gray" className="bi bi-linkedin mx-2" viewBox="0 0 16 16">
